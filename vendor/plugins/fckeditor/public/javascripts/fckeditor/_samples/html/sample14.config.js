...
FCKConfig.CoreStyles.FontFace =
{
    ...
    Overrides    : [
        { Element : 'span', Attributes : { 'class' : /^Font(?:Comic|Courier|Times)$/ } }
    ]
};
...
FCKConfig.CoreStyles.Size =
{
    ...
    Overrides    : [
        { Element : 'span', Attributes : { 'class' : /^Font(?:Smaller|Larger|Small|Big|Double)$/ } }
    ]
};
...
FCKConfig.CoreStyles.Color =
{
    ...
    Overrides    : [
        { Element : 'span', Attributes : { 'class' : /^FontColor(?:1|2|3)$/ } }
    ]
};
...
FCKConfig.CoreStyles.BackColor =
{
    ...
    Overrides    : [
        { Element : 'span', Attributes : { 'class' : /^FontColor(?:1|2|3)BG$/ } }
    ]
};
